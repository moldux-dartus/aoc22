...
/* package profiling-0.1.0.0 */
#ifndef VERSION_profiling
#define VERSION_profiling "0.1.0.0"
#endif /* VERSION_profiling */
#ifndef MIN_VERSION_profiling
#define MIN_VERSION_profiling(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_profiling */
...
#define CURRENT_COMPONENT_ID "profiling-0.1.0.0-inplace-profiling"
